...
using Assets.Scripts.IAJ.Unity.Movement.Actuators;
...
public class MainCharacterController : MonoBehaviour {
    ...
    public float MAX_TIME_LOOK_AHEAD = 1.0f;
    public float AVOID_MARGIN = 4.0f;
    public float AVOID_MARGIN_CHARACTER = 1.0f;
    ...
    public void InitializeMovement(GameObject[] obstacles, List<DynamicCharacter> characters)
    {
        ...
        foreach (var obstacle in obstacles)
        {
            var avoidObstacleMovement = new DynamicAvoidObstacle(obstacle)
            {
                ...
                FanAngle = MathConstants.MATH_PI/6
            };
        ...
        foreach (var otherCharacter in characters)
        {
            if (otherCharacter != this.character)
            {
                ...
                {
                    Character = this.character.KinematicData,
                    AvoidMargin = AVOID_MARGIN_CHARACTER,
        ...
        this.character.OutputFilter = new CarOutputFilter(MathConstants.MATH_PI / 10);
